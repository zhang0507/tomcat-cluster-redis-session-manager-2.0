...
public class RedisConstants {
	...
	public static final String TIMEOUT = "redis.timeout";			//链接超时
	public static final String SO_TIMEOUT = "redis.sotimeout";		//服务请求超时
	public static final String MAX_ATTEMPTS = "redis.maxattempt";	//请求重试次数
	...
	public static final int    DEFAULT_MAX_ATTEMPTS = 5;				//最大失败重试次数
